...
#endif
#if !defined(BOOST_PARAMETER_SPECIFICATION_MAX_ARITY)
// Unlike the variadic MPL sequences provided by Boost.Fusion,
// boost::mpl::vector has a size limit. -- Cromwell D. Enage
#include <boost/mpl/limits/vector.hpp>
#define BOOST_PARAMETER_SPECIFICATION_MAX_ARITY BOOST_MPL_LIMIT_VECTOR_SIZE
#endif
...
#define BOOST_PARAMETER_MAX_ARITY 64
#endif
#if !defined(BOOST_PARAMETER_SPECIFICATION_MAX_ARITY)
#define BOOST_PARAMETER_SPECIFICATION_MAX_ARITY 8
#endif
