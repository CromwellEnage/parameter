...
#ifndef BOOST_PARAMETER_AUX_PREPROCESSOR_IMPL_FORWARDING_OVERLOADS_OLD_HPP
#define BOOST_PARAMETER_AUX_PREPROCESSOR_IMPL_FORWARDING_OVERLOADS_OLD_HPP
...
#define BOOST_PARAMETER_CONSTRUCTOR_OVERLOAD_IMPL(z, n, r, data, elem)       \
    ...
    BOOST_PP_TUPLE_ELEM(5, 2, data)(                                         \
        ...
        BOOST_PP_IF(                                                         \
            n, BOOST_PARAMETER_FUNCTION_FWD_MATCH, BOOST_PP_TUPLE_EAT(3)     \
        )(                                                                   \
            BOOST_PP_CAT(constructor_parameters, __LINE__)                   \
          , n                                                                \
          , ParameterArgumentType                                            \
        )                                                                    \
    ) : BOOST_PARAMETER_PARENTHESIZED_TYPE(BOOST_PP_TUPLE_ELEM(5, 3, data))( \
            BOOST_PP_CAT(constructor_parameters, __LINE__)()(                \
