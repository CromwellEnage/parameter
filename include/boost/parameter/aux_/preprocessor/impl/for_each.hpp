...
#define \
BOOST_PARAMETER_FOR_EACH_pred_aux_BOOST_PARAMETER_FOR_EACH_END_SENTINEL
/**/
...
#define BOOST_PARAMETER_FOR_EACH_build_end_sentinel_tuple(arity) \
    ( \
        BOOST_PP_REPEAT( \
            arity, BOOST_PARAMETER_FOR_EACH_build_end_sentinel, _ \
        ) \
    )
/**/
...
#define BOOST_PARAMETER_FOR_EACH_R(r, arity, list, data, macro) \
    BOOST_PP_CAT(BOOST_PP_FOR_, r)( \
        (list \
            BOOST_PARAMETER_FOR_EACH_build_end_sentinel_tuple(arity) \
          , data \
          , macro \
          , arity \
          , 0 \
